    ...
    public class BonusManager : MonoBehaviour
    {
        ...
        public void RankUpBonus(RPGBonus bonus, RPGTalentTree tree)
        {
            foreach (var t in Character.Instance.CharacterData.Bonuses)
            {
                ...
                //New rank != Max rank
                if (t.rank != bonus.ranks.Count) GeneralEvents.Instance.OnPlayerUpdatedTalentTreeNode(GeneralData.TalentTreeNodeType.Bonus,
                    GeneralData.TalentTreeNodeActionType.Increased, bonus.ID);
                //New rank = Max rank
                else GeneralEvents.Instance.OnPlayerUpdatedTalentTreeNode(GeneralData.TalentTreeNodeType.Bonus,
