...
namespace BLINK.RPGBuilder.Managers
{
    ...
    public class EnchantingPanel : DisplayPanel
    {
        ...
        private void FixedUpdate()
        {
            ...
            EnchantingManager.Instance.EnchantItem(curEnchantedItemData.itemDataID, Character.Instance.CharacterData.ItemEntries[RPGBuilderUtilities.GetItemDataIndexFromDataID(curEnchantedItemData.itemDataID)].enchantmentTierIndex, enchantList[selectedEnchant].enchantment, enchantList[selectedEnchant].itemREF, enchantList[selectedEnchant].itemREF.isEnchantmentConsumed);
            isEnchanting = false;
            curEnchantTime = 0;
            maxEnchantTime = 0;
        }
