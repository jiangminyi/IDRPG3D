	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( ( ( float4( lerpResult200 , 0.0 ) * ( IN.ase_color * float4( (Color203).xyz , 0.0 ) ) ) * temp_output_235_0 ) * temp_output_230_0 ) * _EmissiveIntensity ).rgb;
...
ASEEND*/
//CHKSM=73CD784D89852571B3720329AE6791785791A79F