...
Shader "Vefects/SH_Vefects_VFX_URP_LVL_Up_Custom_Move"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult157 = (float2(_MaskOffset.x , ( _MaskOffset.x + IN.ase_texcoord4.w )));
				float2 texCoord164 = IN.ase_texcoord4.xy * _MaskScale + appendResult157;
				...
				float4 lerpResult198 = lerp( _Color02 , _Color01 , tex2D( _ColorGradientMask, panner202 ).g);
				...
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _ErosionSub + IN.ase_texcoord4.z ) ) ) * saturate( lerpResult181 ) ) ) * saturate( smoothstepResult244 ) ) ) * saturate( distanceDepth188 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner136 = ( windSpeed131 * _DistortionSpeed + ( texCoord130 * _DistortionScale ));
				float Distortion149 = ( saturate( ( tex2D( _DistortionTexture, panner136 ).g * 0.1 ) ) * _DistortionAmount );
				float2 appendResult157 = (float2(_MaskOffset.x , ( _MaskOffset.x + IN.ase_texcoord3.w )));
				float2 texCoord164 = IN.ase_texcoord3.xy * _MaskScale + appendResult157;
				float4 tex2DNode170 = tex2D( _MaskTexture, ( ( Distortion149 * _DistortionMaskIntensity ) + texCoord164 ) );
				float temp_output_180_0 = saturate( ( saturate( pow( tex2DNode170.g , _MaskPower ) ) * _MaskMultiply ) );
				...
				float noises175 = saturate( ( saturate( pow( tex2D( _ErosionTexture, ( panner155 + Distortion149 ) ).g , _ErosionPower ) ) * _ErosionMultiply ) );
				float lerpResult181 = lerp( temp_output_180_0 , noises175 , _ErosionIntensity);
				float2 uv_CookieCutter = IN.ase_texcoord3.xy * _CookieCutter_ST.xy + _CookieCutter_ST.zw;
				float smoothstepResult244 = smoothstep( _CookieCutterErosion , ( _CookieCutterErosion + _CookieCutterErosionSoftness ) , tex2D( _CookieCutter, uv_CookieCutter ).g);
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth188 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth188 = saturate( ( screenDepth188 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _ErosionSub + IN.ase_texcoord3.z ) ) ) * saturate( lerpResult181 ) ) ) * saturate( smoothstepResult244 ) ) ) * saturate( distanceDepth188 ) ) );
				float temp_output_230_0 = saturate( ( IN.ase_color.a * temp_output_235_0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner136 = ( windSpeed131 * _DistortionSpeed + ( texCoord130 * _DistortionScale ));
				float Distortion149 = ( saturate( ( tex2D( _DistortionTexture, panner136 ).g * 0.1 ) ) * _DistortionAmount );
				float2 appendResult157 = (float2(_MaskOffset.x , ( _MaskOffset.x + IN.ase_texcoord.w )));
				float2 texCoord164 = IN.ase_texcoord.xy * _MaskScale + appendResult157;
				float4 tex2DNode170 = tex2D( _MaskTexture, ( ( Distortion149 * _DistortionMaskIntensity ) + texCoord164 ) );
				float temp_output_180_0 = saturate( ( saturate( pow( tex2DNode170.g , _MaskPower ) ) * _MaskMultiply ) );
				...
				float noises175 = saturate( ( saturate( pow( tex2D( _ErosionTexture, ( panner155 + Distortion149 ) ).g , _ErosionPower ) ) * _ErosionMultiply ) );
				float lerpResult181 = lerp( temp_output_180_0 , noises175 , _ErosionIntensity);
				float2 uv_CookieCutter = IN.ase_texcoord.xy * _CookieCutter_ST.xy + _CookieCutter_ST.zw;
				float smoothstepResult244 = smoothstep( _CookieCutterErosion , ( _CookieCutterErosion + _CookieCutterErosionSoftness ) , tex2D( _CookieCutter, uv_CookieCutter ).g);
				...
				float screenDepth188 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth188 = saturate( ( screenDepth188 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _ErosionSub + IN.ase_texcoord.z ) ) ) * saturate( lerpResult181 ) ) ) * saturate( smoothstepResult244 ) ) ) * saturate( distanceDepth188 ) ) );
				float temp_output_230_0 = saturate( ( IN.ase_color.a * temp_output_235_0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner136 = ( windSpeed131 * _DistortionSpeed + ( texCoord130 * _DistortionScale ));
				float Distortion149 = ( saturate( ( tex2D( _DistortionTexture, panner136 ).g * 0.1 ) ) * _DistortionAmount );
				float2 appendResult157 = (float2(_MaskOffset.x , ( _MaskOffset.x + IN.ase_texcoord2.w )));
				float2 texCoord164 = IN.ase_texcoord2.xy * _MaskScale + appendResult157;
				float4 tex2DNode170 = tex2D( _MaskTexture, ( ( Distortion149 * _DistortionMaskIntensity ) + texCoord164 ) );
				float temp_output_180_0 = saturate( ( saturate( pow( tex2DNode170.g , _MaskPower ) ) * _MaskMultiply ) );
				...
				float noises175 = saturate( ( saturate( pow( tex2D( _ErosionTexture, ( panner155 + Distortion149 ) ).g , _ErosionPower ) ) * _ErosionMultiply ) );
				float lerpResult181 = lerp( temp_output_180_0 , noises175 , _ErosionIntensity);
				float2 uv_CookieCutter = IN.ase_texcoord2.xy * _CookieCutter_ST.xy + _CookieCutter_ST.zw;
				float smoothstepResult244 = smoothstep( _CookieCutterErosion , ( _CookieCutterErosion + _CookieCutterErosionSoftness ) , tex2D( _CookieCutter, uv_CookieCutter ).g);
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth188 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth188 = saturate( ( screenDepth188 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _ErosionSub + IN.ase_texcoord2.z ) ) ) * saturate( lerpResult181 ) ) ) * saturate( smoothstepResult244 ) ) ) * saturate( distanceDepth188 ) ) );
				float temp_output_230_0 = saturate( ( IN.ase_color.a * temp_output_235_0 ) );
...
Node;AmplifyShaderEditor.Vector2Node;132;-7056,-2608;Inherit;False;Property;_DistortionScale;Distortion Scale;21;0;Create;True;0;0;0;False;0;False;1,1;1,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;135;-6623.241,-2631.664;Inherit;False;Property;_DistortionSpeed;Distortion Speed;22;0;Create;True;0;0;0;False;0;False;0,0;0.4,-0.75;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;140;-5200,-2576;Inherit;False;Property;_DistortionAmount;Distortion Amount;23;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;143;-9594.237,-875.2904;Inherit;False;Property;_ErosionScale;Erosion Scale;9;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;151;-6339.241,503.7103;Inherit;False;Property;_MaskOffset;Mask Offset;17;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;148;-9210.237,-875.2904;Inherit;False;Property;_ErosionSpeed;Erosion Speed;10;0;Create;True;0;0;0;False;0;False;0,0;0,-0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;156;-6266.24,292.7103;Inherit;False;Property;_MaskScale;Mask Scale;16;0;Create;True;0;0;0;False;0;False;1,1;1,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;158;-6216.476,-158.9345;Inherit;False;Property;_DistortionMaskIntensity;Distortion Mask Intensity;24;0;Create;True;0;0;0;False;0;False;1;-0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;161;-8051.092,-864.8345;Inherit;False;Property;_ErosionPower;Erosion Power;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;163;-8448,-1008;Inherit;True;Property;_ErosionTexture;Erosion Texture;8;0;Create;True;0;0;0;False;3;Space(33);Header(Erosion);Space(13);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-4873.24,490.7103;Inherit;False;Property;_MaskPower;Mask Power;18;0;Create;True;0;0;0;False;0;False;1;1.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;165;-7795.093,-864.8345;Inherit;False;Property;_ErosionMultiply;Erosion Multiply;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;253;-7648,-992;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;170;-5230.779,245.5663;Inherit;True;Property;_MaskTexture;Mask Texture;15;0;Create;True;0;0;0;False;3;Space(33);Header(Mask);Space(13);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;173;-4400,464;Inherit;False;Property;_MaskMultiply;Mask Multiply;19;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-3585.94,225.7981;Inherit;False;Property;_ErosionSub;Erosion Sub;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-3584,896;Inherit;False;Property;_ErosionIntensity;Erosion Intensity;14;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;246;-3456,2048;Inherit;False;Property;_CookieCutterErosion;Cookie Cutter Erosion;28;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;247;-3456,2176;Inherit;False;Property;_CookieCutterErosionSoftness;Cookie Cutter Erosion Softness;29;0;Create;True;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;186;-1888,1456;Inherit;False;Property;_DepthFade;Depth Fade;25;0;Create;True;0;0;0;False;3;Space(33);Header(Depth Fade);Space(13);False;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;209;-2190.04,2459.802;Inherit;False;Property;_CameraOffset;Camera Offset;26;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;205;-3712,-2816;Inherit;False;Property;_Color02;Color 02;6;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;204;-3712,-2560;Inherit;False;Property;_Color01;Color 01;5;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;208;-2634.344,-296.0781;Inherit;False;Property;_UseColor;Use Color;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_VFX_URP_LVL_Up_Custom_Move;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638463808423533785;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638828260119366846;  Use Shadow Threshold;0;0;Cast Shadows;0;638463808434011469;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;0;638853385611923927;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=4D33A9EADB322065979FD3E65F297454AFAA0387